...
#project 001 groups
ProjectRole.create!(name: 'Smuggler', description: 'You have to get through customs somehow.', project: Project. find_by(name: 'Seed Excursion'), start_date: "20/3/18", end_date: "20/3/18")
ProjectRole.create!(name: 'Leader', description: 'Directs the operation.', project: Project. find_by(name: 'Seed Excursion'), start_date: "20/3/18", end_date: "20/3/18")

#project 002 groups
ProjectRole.create!(name: 'Leader', description: 'Directs the operation.', project: Project. find_by(name: 'Interdimensional Travel'), start_date: "20/3/18", end_date: "20/3/18")
...
ProjectRole.create!(name: 'Project Manager', description: 'Manager', project: Project. find_by(name: 'Air Traffic Automation'), start_date: "20/3/18", end_date: "20/3/18")
ProjectRole.create!(name: 'Software Engineer', description: 'Coder', project: Project. find_by(name: 'Air Traffic Automation'), start_date: "20/3/18", end_date: "20/3/18")
ProjectRole.create!(name: 'Data Analyst', description: 'An analyser of data', project: Project. find_by(name: 'Air Traffic Automation'), start_date: "20/3/18", end_date: "20/3/18")
...
ProjectRole.create!(name: 'Project Manager', description: 'Manager', project: Project.find_by(name: 'Drone Protection'), start_date: "20/3/18", end_date: "20/3/18")
ProjectRole.create!(name: 'Software Engineer', description: 'Coder', project: Project.find_by(name: 'Drone Protection'), start_date: "20/3/18", end_date: "20/3/18")
ProjectRole.create!(name: 'Data Analyst', description: 'An analyser of data', project: Project.find_by(name: 'Drone Protection'), start_date: "20/3/18", end_date: "20/3/18")
...
ProjectRole.create!(name: 'Project Manager', description: 'Manager', project: Project. find_by(name: 'Fuels Management'), start_date: "20/3/18", end_date: "20/3/18")
ProjectRole.create!(name: 'Software Engineer', description: 'Coder', project: Project. find_by(name: 'Fuels Management'), start_date: "20/3/18", end_date: "20/3/18")
ProjectRole.create!(name: 'Data Analyst', description: 'An analyser of data', project: Project. find_by(name: 'Fuels Management'), start_date: "20/3/18", end_date: "20/3/18")
...
ProjectRole.create!(name: 'Project Manager', description: 'Manager', project: Project. find_by(name: 'Baggage and Cargo Scanning'), start_date: "20/3/18", end_date: "20/3/18")
ProjectRole.create!(name: 'Software Engineer', description: 'Coder', project: Project. find_by(name: 'Baggage and Cargo Scanning'), start_date: "20/3/18", end_date: "20/3/18")
ProjectRole.create!(name: 'Data Analyst', description: 'An analyser of data', project: Project. find_by(name: 'Baggage and Cargo Scanning'), start_date: "20/3/18", end_date: "20/3/18")
...
ProjectRole.create!(name: 'Project Manager', description: 'Manager', project: Project. find_by(name: 'Electronic Warfare'), start_date: "20/3/18", end_date: "20/3/18")
ProjectRole.create!(name: 'Software Engineer', description: 'Coder', project: Project. find_by(name: 'Electronic Warfare'), start_date: "20/3/18", end_date: "20/3/18")
ProjectRole.create!(name: 'Data Analyst', description: 'An analyser of data', project: Project. find_by(name: 'Electronic Warfare'), start_date: "20/3/18", end_date: "20/3/18")
...
# Project: Electronic Warfare
ProjectRole.create!(name: 'Project Manager', description: 'Manager', project: Project. find_by(name: 'Application Development'), start_date: "20/3/18", end_date: "20/3/18")
ProjectRole.create!(name: 'Software Engineer', description: 'Coder', project: Project. find_by(name: 'Application Development'), start_date: "20/3/18", end_date: "20/3/18")
ProjectRole.create!(name: 'Data Analyst', description: 'An analyser of data', project: Project. find_by(name: 'Application Development'), start_date: "20/3/18", end_date: "20/3/18")
...
ProjectRole.create!(name: 'Project Manager', description: 'Manager', project: Project. find_by(name: 'Agile Software Development'), start_date: "20/3/18", end_date: "20/3/18")
ProjectRole.create!(name: 'Software Engineer', description: 'Coder', project: Project. find_by(name: 'Agile Software Development'), start_date: "20/3/18", end_date: "20/3/18")
ProjectRole.create!(name: 'Data Analyst', description: 'An analyser of data', project: Project. find_by(name: 'Agile Software Development'), start_date: "20/3/18", end_date: "20/3/18")
