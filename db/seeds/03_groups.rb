...
Group.create!(name: 'Project_Manager', description: 'Project Manager group')
Group.create!(name: 'HR', description: 'HR group')
Group.create!(name: 'Software_Engineer', description: 'Software Engineer group')
Group.create!(name: 'Data_Scientist', description: 'Data Science group')
